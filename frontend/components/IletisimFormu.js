      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            id="ad"
            placeholder="İlhan"
            data-testid="isim_input_test"
          />
          {errors.ad && <p data-testid="isim_error">Hata: {errors.ad}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={form.soyad}
            placeholder="Mansız"
            data-testid="soyisim_input_test"
          />
          {errors.soyad && (
            <p data-testid="soyisim_error">Hata: {errors.soyad}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.email && <p data-testid="mailerror">Hata: {errors.email}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="mesaj"
            value={form.mesaj}
            data-testid="mesaj_input_test"
          />
          {errors.mesaj && (
            <p data-testid="mesaj_error">Error: {errors.mesaj}</p>
          )}
        </div>

        {displayData && <Goruntule form={form} />}

        <button data-testid="kayıt_test">Gönder</button>
      </form>
    </div>
  );
};
